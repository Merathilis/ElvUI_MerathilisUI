...
StaticPopupDialogs["merathilis"] = {
	...
	OnAccept = function() E.db.Merathilis.installed = true; MER:SetupUI(); PlaySoundFile([[Sound\Interface\LevelUp.ogg]]) end, -- we set the default value to true, so it won't popup again and then run the Setup function plus I added the lvl sound :P
