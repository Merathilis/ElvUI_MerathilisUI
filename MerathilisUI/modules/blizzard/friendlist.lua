	...
	for i, button in ipairs(buttons) do
		if button:IsShown() and button.online and button.guildIndex then
			if _VIEW == "tradeskill" then
				...
				if isMobile then
					if isAway == 1 then
						displayedName = "|TInterface\\ChatFrame\\UI-ChatIcon-ArmoryChat-AwayMobile:14:14:0:0:16:16:0:16:0:16|t"..displayedName.." |cffE7E716"..L['CHAT_AFK'].."|r"
					...
					if isAway == 1 then
						displayedName = displayedName.." |cffE7E716"..L['CHAT_AFK'].."|r"
					elseif isAway == 2 then
						displayedName = displayedName.." |cffff0000"..L['CHAT_DND'].."|r"
					else
