...
do
	...
	icons = ""
	icons = icons .. E:TextureString(I.Media.RoleIcons.BlizzTank, ":16:16") .. " "
	icons = icons .. E:TextureString(I.Media.RoleIcons.BlizzHealer, ":16:16") .. " "
	icons = icons .. E:TextureString(I.Media.RoleIcons.BlizzDPS, ":16:16")
