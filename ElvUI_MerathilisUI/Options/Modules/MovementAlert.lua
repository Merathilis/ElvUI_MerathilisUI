...
local function BuildSpellArgs()
	...
	-- The profile is not loaded yet when this file runs, the module calls this
	-- again once it is (and after every profile change).
	local db = E.db.mui and E.db.mui.movementAlert
	local custom = db and db.customSpells[E.myclass]
