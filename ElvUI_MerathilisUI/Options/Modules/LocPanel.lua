...
options.locPanel = {
	...
	get = function(info)
		return E.db.mui.locPanel[info[#info]]
	end,
	args = {
		header = {
			order = 1,
			...
			args = {
				enable = {
					...
					set = function(info, value)
						E.db.mui.locPanel[info[#info]] = value
						module:Toggle()
					end,
				},
				linkcoords = {
					...
					order = 2,
					disabled = function()
						return not E.db.mui.locPanel.enable
					end,
					hidden = function()
						return not E.db.mui.locPanel.enable
					end,
				...
				width = {
					...
					name = L["Width"],
					min = 100,
					max = ceil(E.screenWidth) / 2,
					step = 1,
					disabled = function()
						return not E.db.mui.locPanel.enable or E.db.mui.locPanel.autowidth
					end,
					hidden = function()
						return not E.db.mui.locPanel.enable
					end,
				...
				location = {
					...
					args = {
						...
						customColor = {
							...
							name = L["Custom Color"],
							disabled = function()
								return not E.db.mui.locPanel.enable or E.db.mui.locPanel.colorType ~= "CUSTOM"
							end,
							get = function(info)
				...
				coordinates = {
					...
					args = {
						format = {
							...
							type = "select",
							disabled = function()
								return not E.db.mui.locPanel.enable or E.db.mui.locPanel.coordshide
							end,
							set = function(info, value)
								E.db.mui.locPanel[info[#info]] = value
							end,
						...
						customColor_Coords = {
							...
							disabled = function()
								return not E.db.mui.locPanel.enable
									or E.db.mui.locPanel.colorType_Coords ~= "CUSTOM"
									or E.db.mui.locPanel.coordshide
							end,
							get = function(info)
								local t = E.db.mui.locPanel[info[#info]]
								local d = P.locPanel[info[#info]]
						...
						coordshide = {
							...
							disabled = function()
								return not E.db.mui.locPanel.enable or not E.db.mui.locPanel.template == "NoBackdrop"
							end,
						},
					},
				},
				portals = {
					...
					get = function(info)
						return E.db.mui.locPanel.portals[info[#info]]
					end,
					set = function(info, value)
						E.db.mui.locPanel.portals[info[#info]] = value
					end,
					args = {
						enable = {
							type = "toggle",
						...
						customWidthValue = {
							...
							type = "range",
							min = 100,
							max = ceil(E.screenWidth),
							step = 1,
							disabled = function()
								return not E.db.mui.locPanel.portals.customWidth or not E.db.mui.locPanel.enable
							end,
						},
						justify = {
							order = 4,
