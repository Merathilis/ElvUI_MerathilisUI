...
options.achievementTracker = {
	...
	args = {
		...
		size = {
			...
			inline = true,
			disabled = function()
				return not E.db.mui.misc.achievementTracker.enable
			end,
			args = {
				width = {
					order = 1,
		...
		scan = {
			...
			get = function(info)
				return E.db.mui.misc.achievementTracker.scan[info[#info]]
			end,
			set = function(info, value)
				E.db.mui.misc.achievementTracker.scan[info[#info]] = value
			end,
			args = {
				batchSize = {
					order = 1,
				...
				automation = {
					...
					get = function()
						return E.db.mui.misc.achievementTracker.scan.automation.enable
					end,
					set = function(_, value)
						E.db.mui.misc.achievementTracker.scan.automation.enable = value
					end,
				},
				automationOnShow = {
					order = 5,
					...
					get = function()
						return E.db.mui.misc.achievementTracker.scan.automation.onShow
					end,
					set = function(_, value)
						E.db.mui.misc.achievementTracker.scan.automation.onShow = value
					end,
					disabled = function()
						return not E.db.mui.misc.achievementTracker.scan.automation.enable
					end,
				},
				automationOnLogin = {
					order = 6,
					...
					get = function()
						return E.db.mui.misc.achievementTracker.scan.automation.onLogin
					end,
					set = function(_, value)
						E.db.mui.misc.achievementTracker.scan.automation.onLogin = value
					end,
					disabled = function()
						return not E.db.mui.misc.achievementTracker.scan.automation.enable
					end,
