...
function module:Bar_OnEnter()
	module.frame:SetAlpha(1)
end

function module:Bar_OnLeave()
	if module.db.mouseover then module.frame:SetAlpha(0) end
end
...
function module:UpdateBar()
	...
	if E.db.mui.raidmarkers.enable then
		self.frame:Show()
	else
		self.frame:Hide()
	end
...
function module:Initialize()
	module.db = E.db.mui.raidmarkers
	...
	self.frame:Point("BOTTOMRIGHT", E.UIParent, "BOTTOMRIGHT", 300, 15)
	self.frame.buttons = {}
	...
	for index = 1, 9 do
		self.frame.buttons[index] = module:CreateButton(index)
	end
