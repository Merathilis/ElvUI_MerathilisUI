...
local function SetupCVars()
	...
	C_CVar_SetCVar("nameplateOccludedAlphaMult", 0.8)
	...
	C_CVar_SetCVar("nameplateSelectedScale", 1.25)
...
function MER:SetupLayout()
	...
	E.db["movers"]["BuffsMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-272,-17"
	...
	E.db["movers"]["DebuffsMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-260,-189"
...
function MER:SetupNamePlates()
	...
	E.db["nameplates"]["units"]["FRIENDLY_PLAYER"]["name"]["format"] = "[name:abbrev:medium]"
	...
	E.db["nameplates"]["units"]["ENEMY_PLAYER"]["name"]["format"] = "[name:abbrev:medium]"
	...
	E.db["nameplates"]["units"]["FRIENDLY_NPC"]["name"]["format"] = "[name:abbrev:medium]"
...
MER.installTable = {
	...
	Pages = {
		...
		[3] = function()
			...
			PluginInstallFrame.SubTitle:SetText(L["UI Scale"])
			PluginInstallFrame.Desc1:SetText(L["Adjust the UI Scale to fit your screen."])
			PluginInstallFrame.Desc2:SetText(L["Please click the button below to apply the UI Scale."])
			PluginInstallFrame.Desc3:SetText(L["Importance: |cff07D400High|r"])
			PluginInstallFrame.Option1:Show()
			PluginInstallFrame.Option1:SetScript("OnClick", function()
