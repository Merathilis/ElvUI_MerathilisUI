...
function MER:SetupLayout()
	...
	if F.IsAddOnEnabled("ElvUI_RatioMinimapAuras") then
	...
	if F.IsAddOnEnabled("ls_Toasts") then
...
function MER:SetupUnitframes(layout)
	...
	if F.IsAddOnEnabled("ElvUI_mMediaTag") then
