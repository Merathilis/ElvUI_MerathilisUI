...
MER.ExtendedVendor = MER:NewModule('MER_ExtendedVendor', 'AceHook-3.0')
...
MER.HealPrediction = MER:NewModule('MER_HealPrediction', 'AceHook-3.0', 'AceEvent-3.0')
...
MER.Objective = MER:NewModule('MER_ObjectiveTracker', 'AceHook-3.0', 'AceEvent-3.0')
...
MER.RaidMarkers = MER:NewModule('MER_RaidMarkers', 'AceHook-3.0')
...
MER.VehicleBar = MER:NewModule('MER_VehicleBar', 'AceEvent-3.0', 'AceTimer-3.0', 'AceHook-3.0')
