...
options.chat = {
	...
	args = {
		...
		general = {
			...
			guiInline = true,
			get = function(info) return E.db.mui.chat.general[ info[#info] ] end,
			set = function(info, value) E.db.mui.chat.general[ info[#info] ] = value; E:StaticPopup_Show("PRIVATE_RL"); end,
			args = {
				chatButton = {
					order = 1,
					type = "toggle",
