...
L["{rt1} %player% is handing out cookies, go and get one! {rt1}"] = "{rt1} %player%님이 생석을 나눠 주고 있습니다. 하나 가져 가세요! {rt1}"
...
L["{rt1} OMG, wealthy %player% puts %spell%! {rt1}"] = "{rt1} 부유한 %player%님이 %spell% 시전!! {rt1}"
L["Completed"] = "완료"
