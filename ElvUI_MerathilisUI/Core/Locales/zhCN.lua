...
L["{rt1} %player% is handing out cookies, go and get one! {rt1}"] = "{rt1} %player%发糖了, 快点拿哟! {rt1}"
...
L["{rt1} OMG, wealthy %player% puts %spell%! {rt1}"] = "{rt1} 天啊, 土豪 %player% 竟然摆出了 %spell%! {rt1}"
L["Completed"] = "已完成"
