...
L["Show the spell icon along with the name."] = "Verderbniseffekt Symbol samt Namen anzeigen."
...
L["Options for panels providing fast access to raid markers and flares."] = "Option für eine Schlachtzugs Markierungsleiste. Mit dieser hast Du schnelleren Zugriff auf Schlachtzugsmarkierungen und Weltmarker."
