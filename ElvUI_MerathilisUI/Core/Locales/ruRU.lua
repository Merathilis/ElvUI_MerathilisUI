...
L["LFG Member Info"] = "Информация об участниках LFG"
L["Shows role informations in your tooltip in the lfg frame."] = "Показывает информацию о роли во всплывающей подсказке в рамке lfg."
...
L["Maw ThreatBar"] = "Утроба полоса угрозы"
L["Replace the Maw Threat Display, with a simple StatusBar"] = "Замените отображение угроз Утробы на простую строку состояния."
...
L["Sort by Expiration Time"] = "Сортировать по времени действия"
...
-- Talents
L["Talents"] = "Таланты"
L["This feature improves the Talent Window by:\n\n Adding an Extra Button to swap between specializations.\n Adding an Extra Button to use and track duration for Codices and Tomes."] = "Эта функция улучшает окно талантов за счет:\n\n добавления дополнительной кнопки для переключения между специализациями.\n Добавления дополнительной кнопки для использования и отслеживания продолжительности кодексов и томов."
