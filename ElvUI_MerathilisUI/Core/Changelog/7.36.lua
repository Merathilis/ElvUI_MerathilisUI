...
MER.Changelog[736] = {
	...
	NEW = {
		"Chat: New Chat Sidebar - a slim icon bar inside (or next to) the left or right chat panel with online friends/guild counters, durability, copy chat, M+ portals, voice/channels, settings and a scroll-to-bottom button that lights up while the chat is scrolled up. Its copy button replaces ElvUI's (right-click opens the chat menu) and the icons can be reordered with Shift + drag.",
