...
function MER.Utilities.Color.CreateColorFromTable(colorTable)
...
function MER.Utilities.Color.ExtractRGBAFromTemplate(template)
	local r, g, b = MER.Utilities.Color.ExtractRGBFromTemplate(template)
	return r, g, b, 1
end
...
function MER.Utilities.Color.GetRGBFromTemplate(template)
	local r, g, b = MER.Utilities.Color.ExtractRGBFromTemplate(template)
	return { r = r, g = g, b = b }
end
...
function MER.Utilities.Color.GetRGBAFromTemplate(template)
	local r, g, b = MER.Utilities.Color.ExtractRGBFromTemplate(template)
...
---@return number b Blue component (0-1)
---@return number a Alpha component (0-1)
function MER.Utilities.Color.ExtractColorFromTable(colorTable, override)
...
function MER.Utilities.Color.IsRGBEqual(c1, c2)
...
---@return number g Green component (0-1)
---@return number b Blue component (0-1)
function MER.Utilities.Color.HexToRGB(hex)
...
function MER.Utilities.Color.RGBToHex(r, g, b)
...
function MER.Utilities.Color.StringWithHex(text, color)
...
function MER.Utilities.Color.StringWithRGB(text, r, g, b)
	...
	return MER.Utilities.Color.StringWithHex(text, MER.Utilities.Color.RGBToHex(r, g, b))
end
...
function MER.Utilities.Color.StringWithKeystoneLevel(text, level)
	return MER.Utilities.Color.StringWithHex(text, keyStoneLevelHex(level))
end
...
---@param ... RGB
---@return string
function MER.Utilities.Color.GradientStringByRGB(text, ...)
	local colors = { ... }

	if #colors == 1 then
		return MER.Utilities.Color.StringWithRGB(text, colors[1])
	end
...
---@param ... ColorTemplate
---@return string
function MER.Utilities.Color.GradientStringByTemplate(text, ...)
	local templates = { ... }

	if #templates == 1 then
		return MER.Utilities.Color.StringByTemplate(text, templates[1])
	end
