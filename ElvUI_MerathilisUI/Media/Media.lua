...
--Option Icons
F.AddMedia("icon", "Categories/OptionsHome")
F.AddMedia("icon", "Categories/Config")
F.AddMedia("icon", "Categories/System")
F.AddMedia("icon", "Categories/Tips")
F.AddMedia("icon", "Categories/Bill")
F.AddMedia("icon", "Categories/Save")
F.AddMedia("icon", "Categories/More")
F.AddMedia("icon", "Categories/Tool")
F.AddMedia("icon", "Categories/Gradient")
F.AddMedia("icon", "Categories/Changelog")
F.AddMedia("icon", "Categories/actionbars")
F.AddMedia("icon", "Categories/armory")
F.AddMedia("icon", "Categories/auras")
F.AddMedia("icon", "Categories/bags")
F.AddMedia("icon", "Categories/buff_reminder")
F.AddMedia("icon", "Categories/chat")
F.AddMedia("icon", "Categories/item_level")
F.AddMedia("icon", "Categories/mail")
F.AddMedia("icon", "Categories/maps")
F.AddMedia("icon", "Categories/name_hover")
F.AddMedia("icon", "Categories/nameplates")
F.AddMedia("icon", "Categories/notifications")
F.AddMedia("icon", "Categories/panels")
...
F.AddMedia("icon", "Chat/friends")
F.AddMedia("icon", "Chat/guild")
F.AddMedia("icon", "Chat/durability")
F.AddMedia("icon", "Chat/copy")
F.AddMedia("icon", "Chat/portals")
F.AddMedia("icon", "Chat/voice")
F.AddMedia("icon", "Chat/voiceoff")
F.AddMedia("icon", "Chat/settings")
F.AddMedia("icon", "Chat/scroll")
F.AddMedia("icon", "Chat/resize")
...
F.AddMedia("button", "Lock")
F.AddMedia("button", "Unlock")
F.AddMedia("button", "Minus")
F.AddMedia("button", "Plus")
F.AddMedia("button", "Forward")
F.AddMedia("button", "Delete")
F.AddMedia("button", "Setting")
...
F.AddMedia("font", "Armory_Icons.ttf", I.Fonts.Icons, nil, allLocaleBits)
