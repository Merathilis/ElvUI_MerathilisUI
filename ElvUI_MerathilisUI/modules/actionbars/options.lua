			...
			microBar = {
				...
				args = {
					...
					hideInCombat = {
						...
						set = function(info, value) E.db.mui.actionbars.microBar.hideInCombat = value; end,
					},
					hideInOrderHall = {
						order = 3,
						type = "toggle",
						...
						disabled = function() return not E.private.actionbar.enable end,
						get = function(info) return E.db.mui.actionbars.microBar.hideInOrderHall end,
						set = function(info, value) E.db.mui.actionbars.microBar.hideInOrderHall = value; end,
					},
					hideInPetBattle = {
						order = 4,
						type = "toggle",
						...
						disabled = function() return not E.private.actionbar.enable end,
						get = function(info) return E.db.mui.actionbars.microBar.hideInPetBattle end,
						set = function(info, value) E.db.mui.actionbars.microBar.hideInPetBattle = value; end,
					},
				},
			},
		},
