...
-- Lua functions
local _G = _G
local format, gmatch, gsub, match, split = string.format, string.gmatch, string.gsub, string.match, string.split
local tinsert = table.insert
local type, next, unpack = type, next, unpack
-- WoW API / Variables
...
-- GLOBALS: ConvertRGBtoColorString
