...
L["Click to open Emoticon Frame"] = "Öffnet das Fenster mit Emotesymbolen"
...
L["Enable/Disable the MerathilisUI Style from the Blizzard GameMenu."] = "Aktiviert/Deaktiviert den MerathilisUI Stil aus dem Blizzard Spielmenü."
...
L["Adds Wowhead links to the Achievement- and WorldMap Frame"] = "Fügt Wowheadlinks dem Erfolgfenster und der Weltkarte hinzu."
...
L["Show the spell icon along with the name."] = "Verderbnis-Effekt-Symbol samt Namen anzeigen."
...
L["Creates a Global Cooldown Bar"] = "Erstellt eine globale Leiste mit den Abklingzeiten"
...
L["Options for panels providing fast access to raid markers and flares."] = "Option für eine Schlachtzugsmarkierungsleiste. Mit dieser hast Du schnelleren Zugriff auf Schlachtzugsmarkierungen und Weltmarker."
L["Show/Hide raid marks."] = "Zeige/Verstecke Schlachtzugsmarkierungen"
L["Reverse"] = "Umkehren"
L["Modifier Key"] = "Modifierungstaste"
...
L["screenshotQuality"] = "Screenshotqualität"
