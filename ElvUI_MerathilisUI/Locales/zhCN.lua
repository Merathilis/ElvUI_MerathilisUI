...
L["Body"] = "正文"
L["New Template"] = "新建模板"
L["Clear the fields above to create a new template."] = "清空上方字段以创建新模板。"
L["Add / Update"] = "添加 / 更新"
L["Confirm each field above first (Enter, or the checkmark under multiline boxes) - this button re-saves whatever is currently confirmed."] = "请先确认上面的每个字段(按Enter键,或多行框下方的复选标记)——此按钮会重新保存当前已确认的内容。"
L["Saved Templates"] = "已保存的模板"
L["Pick a saved template to load it into the fields above for editing."] = "选择一个已保存的模板，将其载入上方字段以进行编辑。"
L["Please set a template name first."] = "请先设置模板名称。"
L["Please add at least one recipient."] = "请至少添加一个收件人。"
L["This template has no recipients."] = "该模板没有收件人。"
L["Delete %d selected mails?"] = "删除选中的 %d 封邮件？"
L["No mail selected."] = "未选择任何邮件。"
L["Select all mail on this page"] = "选择此页面的所有邮件"
L["Adds checkboxes to the inbox to open or delete multiple mails at once."] = "在收件箱中添加复选框，以便一次打开或删除多封邮件。"
L["Save recipient lists to send the same mail to multiple people at once from the mailbox."] =
	"保存收件人列表，以便从邮箱一次性向多人发送同一封邮件。"
L["Item cleared - re-drag it into the attachment slot, then click Continue."] = "物品已清空 - 请重新将其拖入附件栏，然后点击继续。"
L["Mass send complete."] = "批量发送完成。"
L["Sending %d/%d to %s..."] = "正在发送 %d/%d 给 %s..."
L["Send failed for %s."] = "发送给 %s 失败。"
L["Example: Send to Alts"] = "示例：发送给小号"
L["Gold from Main"] = "来自大号的金币"
L["This is an example template - edit the recipients/subject/body or delete it in Options > Mail > Send Templates."] =
	"这是一个示例模板 - 可在 选项 > 邮件 > 发送模板 中编辑收件人/主题/正文，或将其删除。"
L["Cloth"] = "布料"
L["Leather"] = "皮革"
L["Metal & Stone"] = "金属与矿石"
L["Cooking"] = "烹饪"
...
L["Parts"] = "零件"
L["All Trade Goods"] = "所有商品"
L["Set a default recipient for %s (leave empty to clear):"] = "为 %s 设置默认收件人（留空以清除）："
L["Default recipient: %s"] = "默认收件人：%s"
L["Left-click to attach all - right-click to set a default recipient."] = "左键点击附上全部 - 右键点击设置默认收件人。"
