...
-- Chat
L["Chat Text"] = "채팅 텍스트"
L["Modify the chat text style."] = "채팅 텍스트 스타일 수정"
...
L["Chat EditBox Position"] = "채팅 입력창 위치"
L["Hide Both"] = "양쪽 숨기기"
L["Left Only"] = "왼쪽만 표시"
L["Right Only"] = "오른쪽만 표시"
L["Show Both"] = "양쪽 모두 표시"
L["Min Alpha"] = "최소 투명도"
L["Auto Hide"] = "자동 숨기기"
L["Spacing"] = "간격"
L["New Config"] = "새 설정"
...
L["CHAT_DND"] = "[다른 용무 중]"
L["BACK"] = "뒤로"
L["|cFF00c0failvl|r: %d"] = "|cFF00c0fa아이템 레벨|r: %d"
L["|CFF1EFF00%s|r |CFFFF0000Sold.|r"] = "|CFF1EFF00%s|r |CFFFF0000판매됨|r"
L["Requires level: %d - %d"] = "요구 레벨: %d - %d"
L["Requires level: %d - %d (%d)"] = "요구 레벨: %d - %d (%d레벨)"
L["(+%.1f Rested)"] = "(+%.1f 휴식 보너스)"
L["Unknown"] = "알수없음"
L["Chat Item Level"] = "채팅 아이템 레벨"
L["Shows the slot and item level in the chat"] = "채팅창에 장비 슬롯과 아이템 레벨을 표시합니다"
L["Expand the chat"] = "채팅창 확장"
L["Chat Menu"] = "채팅창 확장"
...
L["Emotes"] = "이모티콘"
L["Damage Meter Filter"] = "데미지 미터 필터"
L["Fade Chat"] = "채팅 흐리기"
L["Auto hide timeout"] = "자동 숨김 시간"
L["Seconds before fading chat panel"] = "채팅 패널이 흐려지기까지의 시간 (초)"
L["Seperators"] = "구분선"
L["Orientation"] = "방향"
...
L["Button"] = "버튼"
L["Item Level Links"] = "아이템 레벨 링크"
L["Filter"] = "필터"
L["Block"] = "차단"
L["Custom Online Message"] = "사용자 정의 접속 메시지"
L["Chat Link"] = "채팅 링크"
...
L["Actionbar 2 (below)"] = "행동단축바 2 (하단)"
L["Actionbar 3 (below)"] = "행동단축바 3 (하단)"
...
L["Count Sub Accounts"] = "하위 계정 수 계산"
L["Value Color"] = "값 색상"
L["Tooltip Anchor"] = "툴팁 기준점"
L["Time Area Height"] = "시간 영역 너비"
...
L["Button #%d"] = "%d 버튼"
L["Pet Journal"] = "애완동물 일지"
L["Show Pet Journal"] = "애완동물 일지 보기"
L["Random Favorite Pet"] = "무작위 좋아하는 애완동물"
L["Screenshot"] = "스크린샷"
...
L["Your Status: Incomplete"] = "내 상태: 미완료"
L["Your Status: Completed on "] = "내 상태: 완료됨 - 날짜: "
...
L["FACTION"] = "진영"
L["Only Icons"] = "아이콘만 표시"
L["Use the new style tooltip."] = "새 스타일의 툴팁을 사용합니다"
L["Display in English"] = "영어로 표시"
L["Show icon"] = "아이콘 표시"
L["Show the spell icon along with the name."] = "주문 아이콘을 이름과 함께 표시합니다"
L["Show the rank of shards."] = "파편의 등급을 표시합니다"
...
L["Unfriendly NPC"] = "비우호적인 NPC"
L["Hostile NPC"] = "적대적인 NPC"
L["Tapped NPC"] = "참여된 NPC"
L["Color 1"] = "색상 1"
L["Color 2"] = "색상 2"
L["Bad Threat"] = "나쁜 위협"
L["Good Threat Transition"] = "좋은 위협 전환"
L["Bad Threat Transition"] = "나쁜 위협 전환"
L["Off Tank"] = "보조 탱커"
...
L["Change the postion of the health text."] = "생명력 수치 위치를 변경합니다"
L["Class Icon Style"] = "직업 아이콘 스타일"
L["Reference"] = "참고자료"
L["Preview"] = "미리보기"
L["Template"] = "템플릿"
L["Please click the button below to read reference."] = "참고자료를 읽으려면 아래 버튼을 클릭하세요"
L["Spec Icon"] = "전문화 아이콘"
L["Show the icon of the specialization."] = "전문화 아이콘을 표시합니다"
L["Race Icon"] = "종족 아이콘"
L["Show the icon of the player race."] = "플레이어의 종족 아이콘을 표시합니다"
L["Health Bar"] = "생명력 바"
L["Group Info"] = "그룹 정보"
...
L["Zone Text"] = "지역명 텍스트"
L["Font Size"] = "글꼴 크기"
L["Subzone Text"] = "하위 지역 텍스트"
L["PvP Status Text"] = "PvP 상태 텍스트"
L["Misc Texts"] = "기타 텍스트"
L["Mail Text"] = "우편 텍스트"
L["Chat Editbox Text"] = "채팅 입력창 텍스트"
L["Gossip and Quest Frames Text"] = "대화 및 퀘스트 창 텍스트"
L["Objective Tracker Header Text"] = "임무 추적기 제목 텍스트"
...
L["Change the shape of ElvUI minimap."] = "ElvUI 미니맵의 모양을 변경합니다"
L["Height Percentage"] = "높이 비율"
L["Percentage of ElvUI minimap size."] = "ElvUI 미니맵 크기의 백분율입니다"
L["MiniMap Buttons"] = "미니맵 버튼"
L["Minimap Ping"] = "미니맵 위치 알림"
...
L["Style Fog of War with special color."] = "전쟁의 안개에 특수 색상을 적용합니다"
...
L["Center"] = "가운데"
L["Right"] = "오른쪽"
L["Minimap Coords"] = "미니맵 좌표"
L["Add coords to your Minimap."] = "미니맵에 좌표를 추가합니다"
...
L["alwaysCompareItems"] = "항상 아이템 비교 표시"
L["alwaysCompareItems_DESC"] = "항상 아이템 비교 툴팁을 표시합니다\r\r기본값: |cffff00000|r"
L["breakUpLargeNumbers"] = "큰 숫자 구분"
L["breakUpLargeNumbers_DESC"] = "큰 숫자에 쉼표를 사용합니다\r\r기본값: |cff00ff001|r"
L["scriptErrors"] = "스크립트 오류 표시"
L["enableWoWMouse"] = "WoW 마우스 활성화"
L["trackQuestSorting"] = "퀘스트 추적 정렬 방식"
L["trackQuestSorting_DESC"] = "새 추적 퀘스트가 설정된 위치에 나열됩니다\r\r기본값: 상단"
L["autoLootDefault"] = "기본 자동 전리품 획득"
L["autoDismountFlying"] = "비행 중 자동 탈것 내리기"
L["removeChatDelay"] = "채팅 지연 제거"
L["screenshotQuality"] = "스크린샷 품질"
...
참고: 해당 스킨이 ElvUI 기본 스킨 설정에서 |cff636363비활성화|r되어 있는 경우, 일부 옵션은 사용할 수 없습니다.]]
...
L["UI Widget"] = "UI 위젯"
L["Fonts"] = "글자"
L["Widgets"] = "메뉴 UI 구성요소"
L["Animation Effect"] = "애니메이션 효과"
L["Type"] = "유형"
L["Fade"] = "부드러운 표시"
L["AddOns"] = "애드온"
...
L["Delves"] = "구렁"
L["COMMUNITIES"] = "커뮤니티"
L["AzeriteUI"] = "아제라이트 UI"
L["GM Chat"] = "GM 채팅"
L["KEY_BINDINGS"] = "단축키 설정"
L["Settings Panel"] = "설정 패널"
L["LFG_TITLE"] = "파티 찾기"
L["LOSS_OF_CONTROL"] = "제어 불가 상태"
L["Editor Mode"] = "편집 모드"
L["Chat Bubbles"] = "말풍선"
L["Debug Tools"] = "디버그 도구"
L["Expansion LandingPage"] = "확장팩 시작 화면"
L["TIMEMANAGER_TITLE"] = "시간 관리자"
...
L["Item Level Font"] = "아이템 레벨 글꼴"
L["Sockets"] = "소켓 정보 표시"
L["Decorative Lines"] = "장식선 표시"
...
L["Only Accept"] = "수락만"
L["Only Complete"] = "완료만"
L["Pause On Press"] = "키 입력 시 자동화 일시 중지"
...
L["Hide the realm name of friends."] = "친구의 서버명을 숨깁니다"
...
L["[ABBR] Delves"] = "구렁"
L["[ABBR] Dragonflight Keystone Hero: Season One"] = "용군단 영웅 S1"
L["[ABBR] Dragonflight Keystone Master: Season One"] = "용군단 달인 S1"
L["[ABBR] Emote"] = "E"
...
L["[ABBR] Follower"] = "추종자"
L["[ABBR] Guild"] = "길드"
L["[ABBR] Halls of Valor"] = "용맹의전당"
L["[ABBR] Hands"] = "손"
L["[ABBR] Head"] = "머리"
L["[ABBR] Held In Off-hand"] = "보조"
L["[ABBR] Heroic"] = "영웅"
L["[ABBR] Instance"] = "인스턴스"
L["[ABBR] Instance Leader"] = "인스턴스 리더"
L["[ABBR] Legs"] = "다리"
L["[ABBR] Looking for Raid"] = "공격대 찾기"
L["[ABBR] Mythic"] = "신화"
L["[ABBR] Mythic Keystone"] = "쐐기"
L["[ABBR] Neck"] = "목"
L["[ABBR] Normal"] = "일반"
L["[ABBR] Normal Scaling Party"] = "일반 스케일링 파티"
L["[ABBR] Officer"] = "O"
L["[ABBR] Party"] = "P"
L["[ABBR] Party Leader"] = "파티장"
L["[ABBR] Path of Ascension"] = "승천의 길"
L["[ABBR] Quest"] = "퀘스트"
L["[ABBR] Raid"] = "레이드"
L["[ABBR] Raid Finder"] = "공격대찾기"
L["[ABBR] Raid Leader"] = "공대장"
L["[ABBR] Raid Warning"] = "공대 경고"
L["[ABBR] Roll"] = "주사위 굴림"
