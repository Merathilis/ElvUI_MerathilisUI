...
L["Body"] = "內文"
L["New Template"] = "新增範本"
L["Clear the fields above to create a new template."] = "清空上方欄位以建立新範本。"
L["Add / Update"] = "新增 / 更新"
L["Confirm each field above first (Enter, or the checkmark under multiline boxes) - this button re-saves whatever is currently confirmed."] = "請先確認上面的每個欄位(按Enter鍵,或多行框下方的核取記號)——此按鈕會重新儲存目前已確認的內容。"
L["Saved Templates"] = "已儲存的範本"
L["Pick a saved template to load it into the fields above for editing."] = "選擇已儲存的範本，將其載入上方欄位以進行編輯。"
L["Please set a template name first."] = "請先設定範本名稱。"
L["Please add at least one recipient."] = "請至少新增一位收件人。"
L["This template has no recipients."] = "此範本沒有收件人。"
L["Delete %d selected mails?"] = "刪除已選取的 %d 封信件？"
L["No mail selected."] = "未選取任何信件。"
L["Select all mail on this page"] = "選取此頁所有信件"
L["Adds checkboxes to the inbox to open or delete multiple mails at once."] = "在收件匣加入核取方塊，可一次開啟或刪除多封信件。"
L["Save recipient lists to send the same mail to multiple people at once from the mailbox."] =
	"儲存收件人清單，以便從信箱一次寄送同一封信給多人。"
L["Item cleared - re-drag it into the attachment slot, then click Continue."] = "物品已清空 - 請重新拖曳至附件欄位，然後點擊繼續。"
L["Mass send complete."] = "批次寄送完成。"
L["Sending %d/%d to %s..."] = "正在寄送 %d/%d 給 %s..."
L["Send failed for %s."] = "寄送給 %s 失敗。"
L["Example: Send to Alts"] = "範例：寄送給小號"
L["Gold from Main"] = "來自主角色的金幣"
L["This is an example template - edit the recipients/subject/body or delete it in Options > Mail > Send Templates."] =
	"這是一個範例範本 - 可在 選項 > 郵件 > 寄送範本 中編輯收件人/主旨/內文，或將其刪除。"
L["Cloth"] = "布料"
L["Leather"] = "皮革"
L["Metal & Stone"] = "金屬與礦石"
L["Cooking"] = "烹飪"
...
L["Parts"] = "零件"
L["All Trade Goods"] = "所有交易物品"
L["Set a default recipient for %s (leave empty to clear):"] = "為 %s 設定預設收件人（留空以清除）："
L["Default recipient: %s"] = "預設收件人：%s"
L["Left-click to attach all - right-click to set a default recipient."] = "左鍵點擊全部附加 - 右鍵點擊設定預設收件人。"
