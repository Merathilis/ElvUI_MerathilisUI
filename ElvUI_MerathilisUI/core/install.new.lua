	...
	["Title"] = L["|cffff7d0aMerathilisUI|r Installation"],
 	...
 	["Pages"] = {
		[1] = function()
			...
			f.Option1:SetText(L['Skip Process'])
		end,
		[2] = function()
			...
			f.Option1:Show()
			f.Option1:SetScript('OnClick', function() SetupMERLayout('Layout') end)
			f.Option1:SetFormattedText("%s", L['Layout'])
		end,
		[3] = function()
			...
			f.Option1:Show()
			f.Option1:SetScript('OnClick', SetupMERChat)
			f.Option1:SetFormattedText("%s", L['Setup Chat'])
		end,
		[4] = function()
			...
			f.Desc3:SetFormattedText("%s", L['Importance: |cffD3CF00Medium|r'])
			f.Option1:Show()
			f.Option1:SetScript('OnClick', function() MER:SetupDts('tank') end)
			f.Option1:SetFormattedText("%s", _G["TANK"])
			f.Option2:Show()
			f.Option2:SetScript('OnClick', function() MER:SetupDts('healer') end)
			f.Option2:SetFormattedText("%s", _G["HEALER"])
			f.Option3:Show()
			f.Option3:SetScript('OnClick', function() MER:SetupDts('dpsMelee') end)
			f.Option3:SetFormattedText("%s", L['Physical DPS'])
			f.Option4:Show()
			f.Option4:SetScript('OnClick', function() MER:SetupDts('dpsCaster') end)
			f.Option4:SetFormattedText("%s", L['Caster DPS'])
		end,
		[5] = function()
			...
			f.Desc3:SetFormattedText("%s", L['Importance: |cff07D400High|r'])
			f.Option1:Show()
			f.Option1:SetScript('OnClick', function() SetupMERActionbars('small') end)
			f.Option1:SetFormattedText("%s", L['Setup ActionBars'].." - 1")
			f.Option2:Show()
			f.Option2:SetScript('OnClick', function() SetupMERActionbars('big') end)
			f.Option2:SetFormattedText("%s", L['Setup ActionBars'].." - 2")
		end,
		[6] = function()
			...
			f.Option1:Show()
			f.Option1:SetScript('OnClick', function() SetupUnitframes() end)
			f.Option1:SetFormattedText("%s", L['Setup Unitframes'])
		end,
		[7] = function()
			...
			f.Desc3:SetFormattedText("%s", L['Importance: |cffD3CF00Medium|r'])
			f.Option1:Show()
			f.Option1:SetScript('OnClick', function() MER:SetupMERAddons(); SetupMERAddons(); end)
			f.Option1:SetFormattedText("%s", L['Setup Addons'])
		end,
		[8] = function()
			...
			f.Option1:Show()
			f.Option1:SetScript('OnClick', InstallComplete)
			f.Option1:SetFormattedText("%s", L['Finished'])
			if InstallStepComplete then
