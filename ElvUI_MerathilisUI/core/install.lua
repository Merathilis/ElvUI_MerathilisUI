...
local function SetupMERDPSLayout(layout)
...
local function SetupMERHEALLayout(layout)
	if not IsAddOnLoaded('ElvUI_BenikUI') then
		E:StaticPopup_Show('BENIKUI')
	end
	...
	E.db["movers"]["LootFrameMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-495,-457"
	E.db["movers"]["AlertFrameMover"] = "TOP,ElvUIParent,TOP,0,-140"
	E.db["movers"]["TotemBarMover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,434,2"
	E.db["movers"]["LossControlMover"] = "BOTTOM,ElvUIParent,BOTTOM,0,465"
	E.db["movers"]["ExperienceBarMover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,390,23"
	E.db["movers"]["ReputationBarMover"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-353,23"
	E.db["movers"]["ObjectiveFrameMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-200,-281"
	E.db["movers"]["VehicleSeatMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,2,-84"
	E.db["movers"]["ProfessionsMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-3,-184"
	E.db["movers"]["ArtifactBarMover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,401,23"
	E.db["movers"]["HonorBarMover"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-364,23"
	E.db["movers"]["TalkingHeadFrameMover"] = "BOTTOM,ElvUIParent,BOTTOM,0,-265"
...
local function SetupMERDPSActionbars(layout)
...
local function SetupMERHEALActionbars(layout)
	E.db["actionbar"]["font"] = "Merathilis Roboto-Black"
	E.db["actionbar"]["fontOutline"] = "OUTLINE"
	E.db["actionbar"]["fontSize"] = 10
	E.db["actionbar"]["macrotext"] = true
	...
	E.db["movers"]["ElvAB_4"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,0,367"
	E.db["movers"]["ElvAB_5"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,353,3"
	E.db["movers"]["ElvAB_6"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-555,390"
	E.db["movers"]["ShiftAB"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,353,2"
	E.db["movers"]["PetAB"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,412,18"
...
local function SetupMERDPSUnitframes(layout)
...
local function SetupMERHEALUnitframes(layout)
	E.db["unitframe"]["font"] = "Merathilis Tukui"
	...
	E.db["unitframe"]["units"]["player"]["customTexts"]["BigName"]["size"] = 20
	E.db["unitframe"]["units"]["player"]["customTexts"]["BigName"]["text_format"] = "[level] | [namecolor][name:medium]"
	...
	E.db["unitframe"]["units"]["target"]["customTexts"]["BigName"]["size"] = 20
	E.db["unitframe"]["units"]["target"]["customTexts"]["BigName"]["text_format"] = "[level] | [namecolor] [name:medium]"
...
function MER:SetupMERAddons(addon)
	-- Skada
	if addon == 'Skada' then
		if IsAddOnLoaded('Skada') then
