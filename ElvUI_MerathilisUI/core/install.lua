...
function MER:SetupLayout(layout, noDataReset)
	...
	if not noDataReset then
		...
		if layout == "dps" then
			...
			MER:SetMoverPosition("ExperienceBarMover", "BOTTOMLEFT", ElvUIParent, "BOTTOMLEFT", 413, 23)
			...
			MER:SetMoverPosition("ArtifactBarMover", "BOTTOMLEFT", ElvUIParent, "BOTTOMLEFT", 424, 23)
