...
function MER:LoadDetailsProfile(layout)
	--[[----------------------------------
	--	Details - Settings
	--]]----------------------------------
...
E.PopupDialogs["MUI_INSTALL_DETAILS_LAYOUT"] = {
	...
	OnAccept = function() MER:LoadDetailsProfile("small"); ReloadUI() end,
	OnCancel = function() MER:LoadDetailsProfile("big"); ReloadUI() end,
