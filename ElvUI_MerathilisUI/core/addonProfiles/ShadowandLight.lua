...
function MER:LoadShadowandLightProfile(layout)
	...
	elseif layout == "big" then
		...
		E.private["sle"]["skins"]["merchant"]["subpages"] = 2
		E.private["sle"]["vehicle"]["enable"] = true
		E.db["sle"]["actionbars"]["vehicle"]["buttonsize"] = 32
		E.db["sle"]["actionbars"]["vehicle"]["buttonspacing"] = 2
		E.db["sle"]["actionbars"]["vehicle"]["template"] = "Transparent"
		E.private["sle"]["equip"]["enable"] = true
		E.private["sle"]["equip"]["setoverlay"] = true
		E.private["sle"]["professions"]["fishing"]["EasyCast"] = true
		E.private["sle"]["professions"]["fishing"]["FromMount"] = true
		...
		E.db["movers"]["SLE_Location_Mover"] = "TOP,ElvUIParent,TOP,0,-6"
		E.db["movers"]["RaidMarkerBarAnchor"] = "BOTTOM,ElvUIParent,BOTTOM,0,57"
		E.db["movers"]["EnhancedVehicleBar_Mover"] = "BOTTOM,ElvUIParent,BOTTOM,0,245"
	end
end

E.PopupDialogs["MUI_INSTALL_SLE_LAYOUT"] = {
	text = L["MUI_INSTALL_SETTINGS_LAYOUT_SLE"],
	OnAccept = function() MER:LoadShadowandLightProfile("small"); ReloadUI() end,
	OnCancel = function() MER:LoadShadowandLightProfile("big"); ReloadUI() end,
