...
L[" - %s settings applied."] = true
L[" - %s profile created! Type /bw, go to Profiles, and change your profile to MerathilisUI."] = true
L["Chat Set"] = true
L["Actionbars Set"] = true
L["Addons Set"] = true
L["DataTexts Set"] = true
L["DPS Unitframes Set"] = true
L["Heal Unitframes Set"] = true
...
L["Setup DPS ActionBars"] = true
L["Setup Heal ActionBars"] = true
L["Setup DPS Unitframes"] = true
L["Setup Heal Unitframes"] = true
L["DataTexts"] = true
...
L["Automatically hide the ObjectiveTracker in boss/arena fights."] = true
