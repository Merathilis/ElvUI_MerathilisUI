...
L[" - %s settings applied."] = " - %s Einstellungen angewandt."
L[" - %s profile created! Type /bw, go to Profiles, and change your profile to MerathilisUI."] = " - %s Profil erstellt! Tippe /bw, gehe in Profile und wähle MerathilisUI."
...
L["DPS Unitframes Set"] = "DPS Einheitenfenster eingestellt"
L["Heal Unitframes Set"] = "Heiler Einheitenfenster eingestellt"
...
L["The AddOn 'ElvUI_VisualAuraTimers' is not enabled. No settings have been changed."] = "Das AddOn 'ElvUI_VisualAuraTimers' ist nicht aktiviert. Keine Einstellungen wurden verändert."
...
L["Setup DPS ActionBars"] = "DPS Aktionsleisten"
L["Setup Heal ActionBars"] = "Heiler Aktionsleisten"
L["Setup DPS Unitframes"] = "DPS Einheitenfenster"
L["Setup Heal Unitframes"] = "Heiler Einheitenfenster"
...
L["Automatically hide the ObjectiveTracker in boss/arena fights."] = "Blendet automatisch den ObjectiveTracker im Boss/Arena Kampf aus."
L["Create decorative underline in class color under the header."] = "Fügt dekorative Unterstriche in Klassenfarbe unter der Kopfzeile hinzu."
