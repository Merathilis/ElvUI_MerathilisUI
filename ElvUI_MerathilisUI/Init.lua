...
MER.Modules.LocationPanel = MER:NewModule("MER_LocationPanel")
MER.Modules.Loot = MER:NewModule("MER_Loot", "AceEvent-3.0")
MER.Modules.LootRoll = MER:NewModule("MER_LootRoll", "AceEvent-3.0")
MER.Modules.Mail = MER:NewModule("MER_Mail", "AceHook-3.0", "AceEvent-3.0")
...
MER.Modules.MovementAlert = MER:NewModule("MER_MovementAlert", "AceEvent-3.0")
