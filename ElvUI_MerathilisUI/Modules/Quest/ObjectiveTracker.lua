...
function module:SortQuestWatches()
	F.WaitFor(function()
...
function module:CosmeticBar(header)
	...
	-- Border
	bar.backdrop.MERshadow:SetShown(self.db.cosmeticBar.border == "SHADOW")
...
---@return nil
function module:BlockHeaderText_SetTextColor(text, r, g, b, a, skip)
...
---@return nil
function module:LineText_SetTextColor(text, r, g, b, a, skip)
...
function module:HandleContainerHeader(frame)
...
function module:HandleLine(line, _)
...
function module:ObjectiveTrackerModule_AddBlock(tracker, block)
