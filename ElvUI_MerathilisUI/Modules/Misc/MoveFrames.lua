...
function module:Remember(frame)
...
function module:Reposition(frame, anchorPoint, relativeFrame, relativePoint, offX, offY, skip)
...
function module:Frame_StartMoving(this, button)
...
function module:Frame_StopMoving(this, button)
	if InCombatLockdown() and this:IsProtected() then
		return
	end
	...
	if button == "LeftButton" then
		...
		module:Remember(this.MoveFrame)
	end
end
...
function module:HandleFramesWithTable(table, parent)
...
function module:HandleAddon(_, addon)
...
function module:HandleElvUIBag()
...
function module:Initialize()
	...
	self.db = E.private.mui.misc.moveFrames
