...
function module:ObjectiveTrackerModule_Update(tracker)
	...
	if tracker and tracker.Header and tracker.Header.Text then
		...
		local r = self.db and self.db.header and self.db.header.classColor and MER.ClassColor.r or self.db.header.color.r
		local g = self.db and self.db.header and self.db.header.classColor and MER.ClassColor.g or self.db.header.color.g
		local b = self.db and self.db.header and self.db.header.classColor and MER.ClassColor.b or self.db.header.color.b
