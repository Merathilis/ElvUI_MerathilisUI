	...
	local loadLibDatabase = function()
		...
		LIB_OPEN_RAID_COOLDOWNS_INFO = {
			...
			[452767] = {
				...
				type = 10,
				sharedid = 102,
			}, --Heartseeking Health Injector (engineering tinker)
			...
			[431914] = {
				...
				type = 11,
				shareid = 101,
			}, --[Potion of Unwavering Focus |A:Professions-ChatIcon-Quality-Tier3:17:18::1|a]
			[431932] = {
				cooldown = 300,
				duration = 30,
				specs = {},
				...
				type = 11,
				shareid = 101,
			}, --[Tempered Potion |A:Professions-ChatIcon-Quality-Tier3:17:18::1|a]
			...
			[107079] = {
				...
				talent = false,
				charges = 1,
				raceid = { [25] = true, [24] = true, [26] = true },
				race = "Pandaren",
				class = "",
				type = 9,
			...
			[97462] = {
				...
				cdtype = "DR",
				nostack = true,
			}, --Rallying Cry. No Stack means that casting two rallying cries at the same time, won't duplicate the effect
			[152277] = {
				cooldown = 60,
				duration = 6,
				specs = { 71 },
			...
			[385060] = {
				...
				class = "WARRIOR",
				type = 5,
			}, --Odyn's Fury (can remove root with Avatar)
			[3411] = {
				cooldown = 30,
				duration = 6,
				specs = { 73 },
			...
			[207349] = {
				...
				class = "DEATHKNIGHT",
				type = 1,
			}, --Summon Dark Arbiter (replaces Gargoyle)
			[219809] = {
				cooldown = 60,
				duration = 8,
				specs = { 250 },
			...
			[414664] = {
				...
				class = "MAGE",
				type = 5,
			}, --Mass Invisibility (only out of combat)
			[449700] = {
				cooldown = 40,
				duration = 0,
				specs = {},
